                            ...
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="small mb-1"><a href="profile.html" class="fw-medium">Shelvey</a> <span
                                            class="text-secondary">request send</span></p>
                                    <p>150 <span class="text-secondary">$</span> <small class="text-secondary">1 min
                                            ago</small>
                                    </p>
                                </div>
                                <div class="col-auto">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="small mb-1"><a href="profile.html" class="fw-medium">John Pattent</a>
                                        <span class="text-secondary">request send</span>
                                    </p>
                                    <p>150 <span class="text-secondary">$</span> <small class="text-secondary">5 min
                                            ago</small>
                                    </p>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <div class="row">
                                        <div class="col">
                                            <p class="small mb-1">
                                                <a href="profile.html" class="fw-medium">Alice Doe</a>
                                                <span class="text-secondary">helped you</span>
                                            </p>
                                            <p>150 <span class="text-secondary">$</span></p>
                                        </div>
                                        <div class="col-auto align-self-center">
