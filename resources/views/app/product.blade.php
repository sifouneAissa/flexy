...
<body class="body-scroll" data-page="product">
    ...
    <main class="h-100">
        ...
        <div class="main-container container">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="card shadow-sm mb-3">
                                    <div class="card-body">
                                        <img src="assets/img/categories1.png" alt="" class="w-100 rounded-15">
                                    </div>
                                </div>
                            </div>
            ...
            <h4 class="mb-2">Samsungs TV SM365200</h4>
            <div class="row mb-3">
            ...
            <div class="row mb-4">
                <div class="col">
                    <a href="cart.html" class="btn btn-default btn-lg shadow-sm w-100">Add to Cart</a>
                </div>
                <div class="col">
                    <a href="cart.html" class="btn btn-success btn-lg shadow-sm w-100 text-white">Buy Now</a>
                </div>
            </div>

            <h5 class="mb-3">Product Description</h5>
            <p class="text-secondary">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque sollicitudin
            ...
            <p class="text-secondary small">** Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque
                sollicitudin dignissim nisi, eget malesuada ligula ultricies sit amet. Suspendisse efficitur ex eu est
                placerat mattis.</p>
            <br />
