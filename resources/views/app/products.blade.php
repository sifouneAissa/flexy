        ...
        <div class="main-container container">
            ...
            <div class="row mb-3">
                <div class="col align-self-center">
                    ...
                    <p class="text-secondary small">3250 products</p>
                </div>
                <div class="col-auto">
                    <nav >
                        <div class="nav nav-tabs border-0" id="nav-tab" role="tablist">
                            ...
                            <button class="btn btn-44 btn-outline-dark ms-2 text-normalcase" id="nav-lists-tab"
                                data-bs-toggle="tab" data-bs-target="#nav-lists" type="button" role="tab"
                                aria-controls="nav-lists" aria-selected="false">
                                <i class="bi bi-list"></i>
                            </button>
                        </div>
                    </nav>
                        ...
                        <div class="tab-pane fade show active" id="nav-thumbnails" role="tabpanel"
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body pt-2">
                                            <div class="row">
                                                <div class="col">
                                                    <p class="small"><small
                                                            class="text-muted size-12">Clothing</small><br />$ 265.00
                                                    </p>
                                                </div>
                                                <div class="col-auto px-0">
                                                    <button class="btn btn-sm btn-link text-color-theme">
                                    ...
                                    <div class="card">
                                        <div class="card-body p-0">
                                            <div class="row mx-0">
                                                ...
                                                <div class="col-6 col-md-4 col-lg-3 border-end p-3 border-top">
                                                    <div class="position-relative">
                                                        <div class="position-absolute start-0 top-0 z-index-1">
                                                            <div class="tag tag-small bg-danger text-white">
                                                                SALE
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <p class="small"><small
                                                                    class="text-muted size-12">Clothing</small><br />$
                                                                65.00</p>
                                                        </div>
                                                        <div class="col-auto px-0">
                                                            <button class="btn btn-sm btn-link text-color-theme">
                                                ...
                                                <div class="col-6 col-md-4 col-lg-3 p-3 border-top">
                                                    <div class="position-relative">
                                                        <div class="position-absolute start-0 top-0 z-index-1">
                                                            <div class="tag tag-small bg-warning text-white">
                                                                1 Offer
                            ...
                            <div class="row mb-4">
                                <div class="col-12 text-center">
                                    <button class="btn btn-light shadow-sm text-color-theme">Load more...</button>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-auto position-relative">
                                                    <div
                                                        class="position-absolute end-0 top-0 px-2 py-1 mx-2 z-index-1 ">
                                                        <button
                                                            class="btn btn-sm btn-26 roudned-circle shadow-sm shadow-danger text-white bg-danger">
                                                            <i class="bi bi-heart size-10 vm"></i>
                                                        </button>
                                                ...
                                                <div class="col position-relative">
                                                    ...
                                                    <h5>$ 265.00</h5>
                                                    <button class="btn btn-sm px-0 text-color-theme">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col position-relative">
                                                    ...
                                                    <p class="mb-0"><small class="text-muted size-12">Samsug TV
                                                            SM5500</small></p>
                                                    <h5>$ 165.00</h5>
                                                    <button class="btn btn-sm px-0 text-color-theme">
                                                        <i class="bi bi-bag-plus"></i> Add to Cart
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col position-relative">
                                                    <div class="position-absolute end-0 top-0 z-index-1 ">
                                                        <div class="tag tag-small bg-danger text-white me-2">
                                                            On Sale
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col position-relative">
                                                    <div class="position-absolute end-0 top-0 z-index-1 ">
                                                        <div class="tag tag-small bg-warning text-white me-2">
                                                            1 Offer
                                                        </div>
                                                    </div>
                                                    <p class="mb-0"><small class="text-muted size-12">Washing
                                                            Machine</small></p>
                                                    <h5>$ 265.00</h5>
                                                    <button class="btn btn-sm px-0 text-color-theme">
                                                        <i class="bi bi-bag-plus"></i> Add to Cart
