...
<body class="body-scroll" data-page="withdraw">
        ...
        <div class="main-container container">
            ...
            <div class="row">
                <div class="col-12 text-center mb-4">
                    <input type="text" class="trasparent-input text-center" value="110.00" placeholder="Enter Amount">
            ...
            <div class="row mb-2">
                <div class="col">
                    <h6 class="title">Amount withdraw to</h6>
                </div>
                <div class="col-auto">
            ...
            <div class="row mb-4">
                <div class="col-12 ">
                    <a href="thankyou3.html" class="btn btn-default btn-lg shadow-sm w-100">
                        Add to Wallet
                    </a>
                </div>
            </div>
