            ...
            <div class="row">
                <div class="col-12 px-0">
                    <div class="list-group list-group-flush rounded-0 bg-none">
                        <a href="message.html" class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-50 rounded-15 p-1 shadow-sm bg-white">
                                        <img src="assets/img/user1.jpg" alt="" class="rounded-12">
                                    </div>
                                </div>
                        ...
                        <a href="message.html" class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-50 rounded-15 p-1 shadow-sm bg-white">
                                        <img src="assets/img/user2.jpg" alt="" class="rounded-12">
                                    </div>
                                </div>
                                <div class="col align-self-center">
                        ...
                        <a href="message.html" class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-50 rounded-15 p-1 shadow-sm bg-white">
                                        <img src="assets/img/user3.jpg" alt="" class="rounded-12">
                                    </div>
                                </div>
                                <div class="col align-self-center">
