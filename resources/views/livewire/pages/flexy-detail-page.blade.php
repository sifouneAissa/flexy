...
<div class="row">
    <div class="col-12 col-md-6 col-lg-6">
        <div class="card card-light shadow-sm mb-4">
            <div class="card-body">
                <livewire:forms.flexy-detail-form />
            </div>
        </div>
    </div>
    <div class="col-12 col-md-6 col-lg-6">
    ...
    @if($providerP)
        <div class="col-12 col-md-6 col-lg-6">
            <div class="card card-light shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="">
                        <p>Percentage : {{$providerP->percentage}} %</p>
                        <p>Operator : {{$providerP->name}}</p>
                        @if($amount)
                            <p>Profit of the transaction : {{$providerP->percentage * $amount / 100 }} DZD</p>
                        @endif
                    </div>
