        ...
        <div class="card mb-3">
            <div class="card-body p-1 position-relative">
                ...
                <figure class="avatar w-100 rounded-15 border">
                    <a href="{{route("flexy-main.index")}}">
                        <img src="{{$f_img}}" alt="" class="w-100">
                    </a>
                </figure>
            </div>
...
{{--                    </div>--}}
                ...
                <div class="card-body pt-2">
                    <div class="row">
                        <div class="col">
                            <p class="small"><small class="text-muted size-20">{{$provider['provider_name']}}</small>
{{--                                <br />$ 265.00--}}
                            </p>
                        </div>
{{--                        <div class="col-auto px-0">--}}
                ...
                <div class="card-body p-1 position-relative">
                    ...
                    <figure class="avatar w-100 rounded-15 border">
                        <a href="{{route("provider.create")}}">
                            <img src="{{'https://placehold.it/'.$m_w.'x'.$m_h.'?text=Add+'}}" alt="" >
                        </a>
                    </figure>
                </div>
                <div class="card-body pt-2">
                    <div class="row">
                        <div class="col">
                            <p class="small"><small class="text-muted size-20">Add new Items</small><br /></p>
                        </div>
                        <div class="col-auto px-0">
                            <a href="{{route("provider.create")}}"  class="btn btn-sm btn-link text-color-theme">
